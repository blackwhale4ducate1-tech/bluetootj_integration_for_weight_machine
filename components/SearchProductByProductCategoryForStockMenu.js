...
const SearchProductByProductCategoryForStockMenu = ({
  updateFormData,
  productInput,
  ...
  const onHandleSearchInput = async text => {
    ...
    try {
      const res = await axios.post(
        `${API_BASE_URL}/api/searchProductByProductCategoryByInput`,
        {
          searchInput: text,
          product_category_name,
...
export default SearchProductByProductCategoryForStockMenu;
