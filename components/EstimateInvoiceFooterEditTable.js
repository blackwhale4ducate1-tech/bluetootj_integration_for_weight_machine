...
const EstimateInvoiceFooterEditTable = ({
  type,
  invoice_no,
  formData,
  updateFormData,
  ...
  return (
    <View>
      ...
      <View
        ...
        <View style={CustomStyles.inputContainer}>
          <Text style={CustomStyles.labelInput}>Accounts Entry :</Text>
          <View>
            <View>
              <Picker
                selectedValue={
                  formData.estimate_account_add_status
                    ? formData.estimate_account_add_status.value.toString()
                    : null
                }
                onValueChange={(itemValue, itemIndex) => {
                  const selectedOption = addToAccountsOptions.find(
                    option => option.value === itemValue,
                  );
                  updateFormData(prevData => ({
                    ...prevData,
                ...
                <Picker.Item label="-- Select --" value={null} />
                {addToAccountsOptions.map(option => (
                  <Picker.Item
                    key={option.value}
                    label={option.label}
                    value={option.value}
...
export default EstimateInvoiceFooterEditTable;
