...
export default function SalesOrderItemWise({formData}) {
  const {data} = useAuth();
    ...
    const getSalesItemWiseData = async company_name => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/api/getSalesOrderItemWiseData?fromDate=${fromDateStr}&toDate=${toDateStr}&productCode=${encodedProductCode}&company_name=${company_name}`,
        );
