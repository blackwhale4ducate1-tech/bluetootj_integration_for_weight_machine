...
export default function SalesDayBookDetails({formData}) {
  const {data} = useAuth();
  ...
  const apiUrl = useMemo(() => {
    ...
    return `${API_BASE_URL}/api/getSalesDayBookDetailData?fromDate=${fromDateStr}&toDate=${toDateStr}&customerName=${encodedCustomerName}&company_name=${data.company_name}`;
