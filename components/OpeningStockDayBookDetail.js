...
export default function OpeningStockDayBookDetail({formData}) {
  const {data} = useAuth();
  ...
  const apiUrl = useMemo(() => {
    ...
    return `${API_BASE_URL}/api/getOpeningStockDayBookDetailData?fromDate=${fromDateStr}&toDate=${toDateStr}&customerName=${encodedCustomerName}&company_name=${data.company_name}`;
