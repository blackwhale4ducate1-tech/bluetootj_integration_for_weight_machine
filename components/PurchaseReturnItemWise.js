...
export default function PurchaseReturnItemWise({formData}) {
  const {data} = useAuth();
  ...
  useEffect(() => {
    const getPurchaseReturnItemWiseData = async company_name => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/api/getPurchaseReturnItemWiseData?fromDate=${fromDateStr}&toDate=${toDateStr}&productCode=${encodedProductCode}&company_name=${company_name}`,
        );
    ...
    getPurchaseReturnItemWiseData(data.company_name);
