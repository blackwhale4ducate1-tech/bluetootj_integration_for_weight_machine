...
// Create PettySalesContext
const PettySalesContext = createContext();

// Create PettySalesProvider component to wrap the app and provide PettySalesContext
export const PettySalesProvider = ({children}) => {
  ...
  const [billingType, setBillingType] = useState('pettySales');
...
// Create usePettySales hook to access PettySalesContext
export const usePettySales = () => useContext(PettySalesContext);
