...
const PurchaseInvoiceFooterEditTable = ({
  type,
  invoice_no,
  formData,
  updateFormData,
  ...
  useEffect(() => {
    const getInvoiceFooterData = async company_name => {
      ...
      try {
        ...
        if (type !== 'production' && response.data.discount_type !== '') {
        ...
        updateFormData(prevFormData => ({
          ...
          ...(type !== 'production' && {
            ...
            roundOff: response.data.round_off,
          }),
...
export default PurchaseInvoiceFooterEditTable;
