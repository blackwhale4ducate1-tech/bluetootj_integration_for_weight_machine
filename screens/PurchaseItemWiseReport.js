...
import PurchaseItemWise from '../components/PurchaseItemWise';
...
export default function PurchaseItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      ...
      {buttonLabel === 'Back' && <PurchaseItemWise formData={formData} />}
    </View>
  );
}
