...
import SalesDayBookDetails from '../components/SalesDayBookDetails';
...
export default function SalesDayBookDetailReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Sales Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && <SalesDayBookDetails formData={formData} />}
    </View>
  );
}
