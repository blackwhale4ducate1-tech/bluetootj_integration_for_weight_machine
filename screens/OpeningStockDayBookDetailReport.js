...
import OpeningStockDayBookDetail from '../components/OpeningStockDayBookDetail';
...
export default function OpeningStockDayBookDetailReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Opening Stock Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && (
        <OpeningStockDayBookDetail formData={formData} />
      )}
    </View>
  );
}
