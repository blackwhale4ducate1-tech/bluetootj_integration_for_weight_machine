...
import SearchCustomerLedgerMenu from '../components/SearchCustomerLedgerMenu';
import CustomStyles from '../components/AddEditModalStyles';
import {Appbar, TextInput, IconButton} from 'react-native-paper';

export default function OutstandingCustomerReport() {
      ...
      <View style={CustomStyles.safeContainer}>
        ...
        {buttonLabel === 'Create Report' && (
          <View style={{margin: 10}}>
            ...
            <SearchCustomerLedgerMenu
              handleUpdateNameBalance={handleUpdateNameBalance}
              ledgerInput={formData.ledgerName}
              customerType="client"
            />
        ...
        {buttonLabel === 'Back' && (
          <OutstandingCustomerReportTable
            formData={formData}></OutstandingCustomerReportTable>
        )}
      </View>
    </ScrollView>
  );
