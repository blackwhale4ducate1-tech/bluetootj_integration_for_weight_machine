...
import PurchaseReturnItemWise from '../components/PurchaseReturnItemWise';

export default function PurchaseReturnItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      ...
      {buttonLabel === 'Back' && <PurchaseReturnItemWise formData={formData} />}
    </View>
  );
}
