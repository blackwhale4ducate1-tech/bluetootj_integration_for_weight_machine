...
import PurchaseReturnDayBookDetail from '../components/PurchaseReturnDayBookDetail';

export default function PurchaseReturnDayBookDetailReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Purchase Return Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && (
        <PurchaseReturnDayBookDetail formData={formData} />
      )}
    </View>
  );
}
