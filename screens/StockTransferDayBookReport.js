...
import StockTransferDayBook from '../components/StockTransferDayBook';
import CustomStyles from '../components/AddEditModalStyles';
import {Appbar, TextInput, IconButton} from 'react-native-paper';

export default function StockTransferDayBookReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Stock Transfer Day Book Report"
      ...
      {buttonLabel === 'Back' && <StockTransferDayBook formData={formData} />}
    </View>
  );
}
