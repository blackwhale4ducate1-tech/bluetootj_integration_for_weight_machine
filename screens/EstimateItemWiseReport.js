...
import EstimateItemWise from '../components/EstimateItemWise';
...
export default function EstimateItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Estimate Item Wise Report"
      ...
      {buttonLabel === 'Back' && <EstimateItemWise formData={formData} />}
    </View>
  );
}
