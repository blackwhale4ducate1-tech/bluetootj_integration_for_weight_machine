...
import OpeningStockDayBook from '../components/OpeningStockDayBook';
...
export default function OpeningStockDayBookReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Opening Stock Day Book Report"
      ...
      {buttonLabel === 'Back' && <OpeningStockDayBook formData={formData} />}
    </View>
  );
}
