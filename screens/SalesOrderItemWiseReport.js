...
import SalesOrderItemWise from '../components/SalesOrderItemWise';
...
export default function SalesOrderItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Sales Order Item Wise Report"
      ...
      {buttonLabel === 'Back' && <SalesOrderItemWise formData={formData} />}
    </View>
  );
}
