...
import StockTransferDayBookDetail from '../components/StockTransferDayBookDetail';
import CustomStyles from '../components/AddEditModalStyles';
import {Appbar, TextInput, IconButton} from 'react-native-paper';

export default function StockTransferDayBookDetailReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Stock Transfer Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && (
        <StockTransferDayBookDetail formData={formData} />
      )}
    </View>
  );
}
