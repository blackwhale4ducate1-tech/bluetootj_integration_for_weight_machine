...
import ProductionInvoiceItemsMenu from '../components/ProductionInvoiceItemsMenu';
  ...
  return (
    <View>
      <ScrollView contentContainerStyle={{backgroundColor: COLORS.white}}>
        ...
        <InvoiceHeaderTable type="production"></InvoiceHeaderTable>
        <ProductionInvoiceItemsMenu type="production" />
        <InvoiceFooterForAll
          type="production"
