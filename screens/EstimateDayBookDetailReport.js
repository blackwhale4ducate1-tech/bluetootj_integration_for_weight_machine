...
import EstimateDayBookDetails from '../components/EstimateDayBookDetails';
...
export default function EstimateDayBookDetailReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Estimate Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && <EstimateDayBookDetails formData={formData} />}
    </View>
  );
}
