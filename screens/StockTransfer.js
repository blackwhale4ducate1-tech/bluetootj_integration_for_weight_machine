...
import StockTransferInvoiceHeaderTable from '../components/StockTransferInvoiceHeaderTable';
...
import StockTransferItemsMenu from '../components/StockTransferItemsMenu';
  ...
  return (
    <View>
      <ScrollView contentContainerStyle={{backgroundColor: COLORS.white}}>
        ...
        <StockTransferInvoiceHeaderTable />
        <StockTransferItemsMenu />
        <InvoiceFooterForAll
          type="stock_transfer"
          handleTaxChange={handleTaxChange}
          handlePriceListChange={handlePriceListChange}
          invoiceFooterType="StockTransferInvoiceFooterTable"></InvoiceFooterForAll>
