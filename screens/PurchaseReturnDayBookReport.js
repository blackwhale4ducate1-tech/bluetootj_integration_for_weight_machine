...
import SearchCustomerForDayBookModal from '../components/SearchCustomerForDayBookModal';
...
import PurchaseReturnDayBook from '../components/PurchaseReturnDayBook';

export default function PurchaseReturnDayBookReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Purchase Return Day Book Report"
      ...
      {buttonLabel === 'Back' && <PurchaseReturnDayBook formData={formData} />}
    </View>
  );
}
