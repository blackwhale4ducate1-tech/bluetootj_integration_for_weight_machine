...
import OpeningStockItemWise from '../components/OpeningStockItemWise';
...
export default function OpeningStockItemWiseReport() {
    ...
    <SafeAreaView style={styles.safeContainer}>
      <View style={CustomStyles.safeContainer}>
        <Appbar.Header style={CustomStyles.appHeader}>
          ...
          />
          <Appbar.Content
            title="Opening Stock Item Wise Report"
        ...
        {buttonLabel === 'Back' && <OpeningStockItemWise formData={formData} />}
      </View>
    </SafeAreaView>
  );
}
