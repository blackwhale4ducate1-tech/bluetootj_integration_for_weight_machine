...
import OutstandingStatementReportTable from '../components/OutstandingStatementReportTable';
...
export default function OutstandingStatementReport() {
  ...
  const onClickBtn = () => {
    if (!formData.fromDate || !formData.toDate || formData.username === '') {
      setFormData({
        ...formData,
      ...
      <ScrollView>
        <View style={CustomStyles.safeContainer}>
          <Appbar.Header style={CustomStyles.appHeader}>
            ...
            />
            <Appbar.Content
              title="Outstanding Statement Report"
          ...
          {buttonLabel === 'Back' && (
            <OutstandingStatementReportTable formData={formData} />
          )}
        </View>
      </ScrollView>
    </SafeAreaView>
