...
import PettySalesDayBookDetails from '../components/PettySalesDayBookDetails';
...
export default function PettySalesDayBookDetailsReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="PettySales Day Book Detail Report"
      ...
      {buttonLabel === 'Back' && (
        <PettySalesDayBookDetails formData={formData} />
      )}
    </View>
  );
}
