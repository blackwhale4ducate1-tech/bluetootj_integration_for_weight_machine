...
import EstimateDayBook from '../components/EstimateDayBook';
...
export default function EstimateDayBookReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="Estimate Day Book Report"
      ...
      {buttonLabel === 'Back' && <EstimateDayBook formData={formData} />}
    </View>
  );
}
