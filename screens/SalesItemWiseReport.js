...
import SalesItemWise from '../components/SalesItemWise';
...
export default function SalesItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      ...
      {buttonLabel === 'Back' && <SalesItemWise formData={formData} />}
    </View>
  );
}
