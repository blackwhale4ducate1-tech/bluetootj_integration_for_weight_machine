...
import PettySalesItemWise from '../components/PettySalesItemWise';
...
export default function PettySalesItemWiseReport() {
  ...
  return (
    <View style={CustomStyles.safeContainer}>
      <Appbar.Header style={CustomStyles.appHeader}>
        ...
        />
        <Appbar.Content
          title="PettySales Item Wise Report"
      ...
      {buttonLabel === 'Back' && <PettySalesItemWise formData={formData} />}
    </View>
  );
}
